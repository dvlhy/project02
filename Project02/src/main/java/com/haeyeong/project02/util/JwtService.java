package com.haeyeong.project02.util;
...
import com.haeyeong.project02.util.UserVO;
...
public class JwtService{
	...
	//[0] User 정보를 이용해서 - JWT 생성
	public String createLogoutToken(UserVO user) {
		...
		return  Jwts.builder()
				...
				//typ 를 셋팅 안해주면 오류 발생한다.
				 ...
				 //[3] 만료 시간
				 .setExpiration(new Date(curTime + 0))
